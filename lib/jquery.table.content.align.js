        ...
        setAlign: function () {
            var me = this,
                ...
                var padding = parseInt(td.first().css('padding-top')) + parseInt(td.first().css('padding-bottom')),
                    maxHeight = td.first().height() - padding;

            this.element.find('.wrapper-bottom').each(function(){
                var $this = $(this);
                    $this.css('height', '100%');
                    maxHeight = $this.closest('td').height()+padding;
            });
            td.each(function(){
                var $this = $(this),
                ...
                if ($alignElement.length > 0){
                    ...
                    var $html  = $this.html(),
                        ...
                        $wrapper.css({'height': maxHeight, 'position': 'relative'});
